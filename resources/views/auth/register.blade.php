            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="second_surname" class="col-md-4 col-form-label text-md-end">{{ __('Second Surname') }}</label>

                            <div class="col-md-6">
                                <input id="second_surname" type="text" class="form-control" name="second_surname" value="{{ old('second_surname') }}" autocomplete="second_surname">
